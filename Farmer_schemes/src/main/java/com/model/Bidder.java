...
public class Bidder 
{
	...
	public String toString() {
		return "bidder [bid=" + bid + ", full_name=" + full_name + ", contact_no=" + contact_no + ", email=" + email
				+ ", address=" + address + ", city=" + city + ", state=" + state + ", pincode=" + pincode
				+ ", account_no=" + account_no + ", ifsc_code=" + ifsc_code + ", adhar_no=" + adhar_no
				+ ", adhar_fname=" + adhar_fname + ", pan_fname=" + pan_fname + ", trader_license_fname="
				+ trader_license_fname + ", password=" + password + ", status=" + status + "]";
	}
